      ...
      <div class="container-fluid dashboard-content">
        ...
        <div class="row">
          ...
          <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
            <div class="card">
              <h5 class="card-header">Registro de lote</h5>
              <div class="card-body">
                <form action="javascript:void(0);" method="POST" id="loteform" onsubmit="app.guardar()">
                  <div class="form-group">
                    <label for="descripcion">Descripción:</label>
                    <input id="lote_descripcion" type="text" name="lote_descripcion" data-parsley-trigger="change" autocomplete="off" class="form-control" autofocus>
                  </div>
          ...
          <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
            <div class="card">
              <h5 class="card-header"> Listado de lote</h5>
              <div class="card-body">
                <div id="lotes" class="table-responsive"></div>
              </div>
            </div>
          </div>
        </div>
