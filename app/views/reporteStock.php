...
<body>
  ...
  <div class="dashboard-main-wrapper">
    ...
    <div class="dashboard-wrapper" id="containerbody">
      <div class="container-fluid dashboard-content">
              ...
              <div class="page-breadcrumb">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Reporte Stock</li>
                  </ol>
                </nav>
              </div>
            </div>
        ...
        <!-- ============================================================== -->
        <div class="row">
        <?php if (!empty($_SESSION['permisos'][REPORTE_STOCK]['w']) || !empty($_SESSION['permisos'][REPORTE_STOCK]['u'])) { ?>
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
              <h5 class="card-header">Reporte de Stock</h5>
              <div class="card-body">
                <div class="form-row">
                  ...
                  <div class="col-md-4 mb-2" id="div_listatipop"><br>
                    <div class="select-wrapper">
                    <label for="formapago"></label>
                    <div id="formapago">
                    <div id="selectorComprobante"></div>
                    <span class="title" data-placeholder="Ubicacion"></span>
                          <i class="fa-solid fa-chevron-down icon"></i>
                  ...
                  <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 p-1" style="margin: 2% 0% 0% 0%;">
                    ...
                    <a href="../views/reporteStock.php" class="btn btn-space btn-danger" title="Limpiar" style="border-radius: 50%; width: 50px; height: 50px;"><i class="fa fa-eraser"></i></a>
 ...
 -->
  ...
  <script src="../src/reportestock.js"></script>
</body>
