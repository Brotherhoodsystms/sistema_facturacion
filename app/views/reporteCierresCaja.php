...
<body>
  ...
  <div class="dashboard-main-wrapper">
    ...
    <div class="dashboard-wrapper" id="containerbody">
      <div class="container-fluid dashboard-content">
              ...
              <div class="page-breadcrumb">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Reporte Cierres Caja</li>
                  </ol>
                </nav>
              </div>
            </div>
        ...
        <!-- ============================================================== -->
        <div class="row">
          <?php if (!empty($_SESSION['permisos'][REPORTE_CIERRES]['w']) || !empty($_SESSION['permisos'][REPORTE_CIERRES]['u'])) { ?>
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
              <div class="card">
                <h5 class="card-header">Reporte de Cierres Caja</h5>
                <div class="card-body">
                  <div class="form-row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 p-1">
                      <div class="select-wrapper">
                        ...
                        <select id="reporte_factura" name="reporte_factura" class='form-control' autofocus onchange="app.seleccionFecha()">
                          ...
                          <!-- <option value="8">Ubicación</option> -->
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 p-1" hidden>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 p1" id="div_listatipop">
                      <label for="formapago">Ubicación</label>
                      <div id="formapago">
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 p-1" style="margin: 2% 0% 0% 0%;">
                      ...
                      <a href="../views/reporteCierresCaja.php" class="btn btn-space btn-danger" title="Limpiar" style="border-radius: 50%; width: 50px; height: 50px;"><i class="fa fa-eraser"></i></a>
 ...
 -->
          ...
          <div class=" col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 p-3">
            <div class="card">
              <h5 class="card-header"> Listado de Cierres Caja</h5>
              <div class="card-body">
    ...
    <script src="../src/reportecierrescaja.js"></script>
</body>
