  ...
  <table align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style="text-align:center;">
    <tbody>
      ...
      <tr>
        <td>
          <div class="x_sgwrap">
            <p>Hola Prueba Envio correo electronico </p>
          </div>
          <p>Bienvenido a nuestra Sistema de Inventarios .</p>
          <p>Ahora puedes ralizar tus procesos de inventario y facturacion electronica .</p>
          <p>Accede a tu cuenta con tus credenciales:</p>
          <p>Usuario: <strong><?= $data['email']; ?></strong></p>
          <p>Usuario: <strong>Recuerda tu contraseña es tu numero de cedula </strong></p>
