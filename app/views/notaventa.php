...
getpermisos(COMPROBANTE_SALIDA); ?>
...
<body>
    ...
    <div class="dashboard-wrapper" id="containerbody">
      <div class="container-fluid dashboard-content">
        ...
        <div class="row">
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
              <h5 class="card-header"> Listado de Comprobante de Salida</h5>
              <div class="card-body">
                <div id="notadeventa" class="table-responsive"></div>
              </div>
            </div>
          </div>
        </div>
  ...
  <script src="../src/notaventa.js"></script>
</body>
