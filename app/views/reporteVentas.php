...
<body>
  ...
  <div class="dashboard-main-wrapper">
    ...
    <div class="dashboard-wrapper" id="containerbody">
      <div class="container-fluid dashboard-content">
        ...
        <!-- ============================================================== -->
      <div class="row">
        <?php if (!empty($_SESSION['permisos'][REPORTE_VENTA]['w']) || !empty($_SESSION['permisos'][REPORTE_VENTA]['u'])) { ?>
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                ...
                <div class="form-row">
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 p-1">
                    ...
                    <select id="reporte_factura" name="reporte_factura" class='form-control' autofocus onchange="app.seleccionFecha()">
                      ...
                      <option value="2">Identificador del cliente</option>
                  ...
                  <div class="col-md-4 mb-2" id="div_parametro"><br>
                    <div class="select-wrapper">
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 p1" id="div_listaforma"><br>
                    <div class="select-wrapper">
                    <label for="formapago"></label>
                    <div id="formapago">
                    <div id="selectorFormapago"></div>
                    <span class="title" data-placeholder="Forma de pago"></span>
                          <i class="fa-solid fa-chevron-down icon"></i>
                  </div>
                  </div>
                  </div>
                  ...
                  <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 p-1" style="margin: 2% 0% 0% 0%;">
                    ...
                    <a href="../views/reporteVentas.php" class="btn btn-space btn-danger" title="Limpiar" style="border-radius: 50%; width: 50px; height: 50px;"><i class="fa fa-eraser"></i></a>
                  <!--
       ...
       <?php } ?>
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12"><br>
            <div class="card">
              ...
              <div class="card-body">
                <div id="tablaParametros" class="table-responsive"></div>
              </div>
            </div>
          </div>
        </div>
  ...
  <script src="../src/reporteVentas.js"></script>
</body>
