<?php
/*
 * Creado por Bryan Alejnadro Chamba Freire
 */
...
class fac_ele
{
  ...
  function correos($numeroAutorizacion)
  {
    try {
      $factura = $numeroAutorizacion . '.xml';
      $filex = 'C:\\xammp\\htdocs\\seli_logistics_inventario\\app\\facturas\\1724254352001\\comprobrantes\\autorizados\\' . $factura;
      $filep = 'C:\\xammp\\htdocs\\seli_logistics_inventario\\app\\facturas\\1724254352001\\comprobrantes\\pdf\\' . $numeroAutorizacion . '.pdf';
      ...
      $mail->Username = 'javierlobitort@gmail.com';
      // Contraseña
      $mail->Password = 'davidlobort912@';

      //Añadimos la direccion de quien envia el corre, en este caso
      //YARR Blog, primero el correo, luego el nombre de quien lo envia.
      $mail->setFrom('javierlobitort@gmail.com', 'EMPRESA');
      $mail->addAddress('javierlobitort@gmail.com');
      $mail->AddAttachment($filex, $numeroAutorizacion . '.xml');
      $mail->AddAttachment($filep, $numeroAutorizacion . '.pdf');
