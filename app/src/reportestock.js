const app = new (function () {
    ...
    this.listadoReporteReserva = (data = null) => {
        ...
        html += "<th>Detalle</th>";
        html += "<th>Precio de venta </th>";
        html += "<th>Stock</th>";
        html += "<th>Precio de compra</th>";
        html += "<th>Total</th>";
        html += "</tr>";
        html += "</thead>";
        html += "<tbody>";
        data1.forEach((element) => {
            html += "<tr>";
                 html +="<td> <strong>" +element.ubicacion_id + "</strong> </td>";
                 html +="<td> <strong>" +element.sucursal_nombre + "</strong> </td>";
                 html +="<td> <strong>" +element.bodega_descripcion + "</strong> </td>";
                 html +="<td> <strong>" +element.ubicacion_descripcion + "</strong> </td>";
                 html +="<td> <strong>" +element.producto_codigoserial + "</strong> </td>";
                 html +="<td> <strong>" +element.producto_descripcion + "</strong> </td>";
                 html +="<td> <strong>" +element.producto_precio_mayor + "</strong> </td>";
                 html +="<td> <strong>" +element.ubicacion_cantidad + "</strong> </td>";
                 html +="<td> <strong>" +element.producto_precio_menor + "</strong> </td>";
                 html +="<td> <strong>" + (element.ubicacion_cantidad * element.producto_precio_menor) + "</strong> </td>";
                 
          });
         var total=data.totales;
         html +=
         "<tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td>Total</td><td>"+total.total+"</td></tr></tbody></table>";
       this.tbody.innerHTML = html;
       app.exportaciones();
        } else {
          fetch("../controllers/reporte/listadoUbicacion.php")
            .then((res) => res.json())
            .then((data) => {
              var data1=data.busqueda;
              html =
    ...
    this.reporteBuscar = () => {
        ...
        if (this.reporte_reserva.value === "6") {
          ...
          fetch("../controllers/reporte/obtenerStockFecha.php", {
            method: "POST",
            body: form1,
          })
            .then((res) => res.json())
