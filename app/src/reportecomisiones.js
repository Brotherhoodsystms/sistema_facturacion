const app = new (function () {
    ...
    this.listadoReporteReserva = (data = null) => {
      ...
      data1.forEach((element) => {
          html += "<tr>";
          html +="<td> <strong>" +element.id_comision + "</strong> </td>";
          html +="<td> <strong>" +element.nombreComercial + "</strong> </td>";
           html +="<td> <strong>" +element.vendedor_nombres + "</strong> </td>";
           html +="<td> <strong>" +element.vendedor_dni + "</strong> </td>";
           html +="<td> <strong>" +element.fecha_ingreso + "</strong> </td>";
           html +="<td> <strong>" +element.factura_serie + "</strong> </td>";
           html +="<td> <strong>" +element.valor + "</strong> </td>";
           html +="<td> <strong>" +element.comprobante_descripcion + "</strong> </td>";
        });
       var total=data.totales;
       html +=
       "<tr><td></td><td></td><td></td><td></td><td></td><td>Total</td><td>"+total.total+"</td><td></td></tr></tbody></table>";
     this.tbody.innerHTML = html;
     app.exportaciones();
      } else {
        fetch("../controllers/reporte/listadoComisiones.php")
          .then((res) => res.json())
          .then((data) => {
            var data1=data.busqueda;
            html =
    ...
    this.reporteBuscar = () => {
        ...
        if (this.reporte_reserva.value === "6") {
          ...
          fetch("../controllers/reporte/obtenerComisionFecha.php", {
            method: "POST",
            body: form1,
          })
            .then((res) => res.json())
          ...
          fetch("../controllers/reporte/obtenerComisionesParametroComision.php", {
            method: "POST",
            body: form,
          })
            .then((res) => res.json())
