    ...
    <table id="factura_head">
      <tr>
        ...
        <td class="info_empresa">
          ...
          ?>
          <div>
            <p class="h2">EGRESO DE MERCADERIA
            </p><br>
            <p class="h2">PICKING</p>
        ...
        <td class="info_factura">
          <div class="round">
            <span class="h3">EGRESO DE MERCADERIA</span>
            <p>Egreso #: <strong><?php echo $reserva['historial_tipo_proceso'];
                                  ?></strong></p>
            ...
            <p>Fecha y Hora: <strong><?php $row = $detalleTodos[0];
                                      echo $reserva['historial_fecha'];
                                      ?></strong></p>
        ...
        <td class="info_cliente">
          <div class="round">
            ...
            <table class="datos_cliente">
              ...
              <tr>
                <td><label>DESPACHO A:</label>
                  <p><?php
                      echo ($row['bodega_descripcion']); ?></p>
                </td>
              </tr>
            </table>
          </div>
