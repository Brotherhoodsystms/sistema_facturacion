  ...
  <div id="page_pdf">
      ...
      <tr>
        ...
        <td class="info_factura">
          <div class="round">
            ...
            <p>No. Factura:<strong><?php echo $establecimiento; ?>-<?php echo $ptoEmision; ?>-<?php echo (str_pad($reserva['factura_serie'], 9, "0", STR_PAD_LEFT)); ?></strong></p>
            <p>NÚMERO DE AUTORIZACIÓN
            </p>
            <p>
              <?php echo $reserva['claveAcceso']; ?>
            </p>
            ...
            <p class="center">CLAVE DE ACCESO <br>
              <?php barcode('../../../public/barra/' . $reserva['claveAcceso'] . '.png', $reserva['claveAcceso'], 35, 'horizontal', 'code128', true) ?>
              <img src="../../../public/barra/<?php echo $reserva['claveAcceso']; ?>.png" style="width:4000%;">
              <br><br>
            </p>
    ...
    <table id="factura_detalle">
      ...
      <tbody id="detalle_productos">
        ...
        ?>
          <tr>
            <td class="textcenter"><?php echo $detalle['detafact_cantidad']; ?></td>
            <td><?php echo $detalle['producto_descripcion']; ?></td>
            <td class="textright"><?php echo $detalle['detafact_preciounitario']; ?></td>
            <td class="textright"><?php echo $detalle['detafact_total']; ?></td>
          </tr>
        <?php
        }
        ?>
      ...
      <tfoot id="detalle_totales">
        ...
        <tr>
          ...
          <td class="textright"><span><?php echo $reserva['factura_iva'];; ?></span></td>
        </tr>
        <tr>
